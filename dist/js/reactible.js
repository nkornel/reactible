...
var EditableFieldBox = React.createClass({
    ...
    render: function render() {
        return React.createElement(
            ...
            React.createElement(EditableField, { fieldType: this.props.fieldType, fieldValue: this.state.fieldValue, fieldSource: this.props.fieldSource, fieldSelected: this.props.fieldSelected, fieldName: this.props.fieldName })
        );
    }
});
...
var EditableField = React.createClass({
    ...
    render: function render() {
        return React.createElement(
            ...
            React.createElement(EditableEditBox, { viewStatus: this.state.viewStatus, fieldType: this.props.fieldType, callbackViewParent: this.handleCloseClick, fieldValue: this.props.fieldValue, fieldSource: this.props.fieldSource, fieldName: this.props.fieldName, fieldSelected: this.props.fieldSelected })
        );
    }
});
...
var EditableEditBox = React.createClass({
    ...
    mountComponent: function mountComponent() {
        switch (this.props.fieldType) {
            case 'text':
                ...
                break;
            case 'select':
                return React.createElement(EditableSelectInput, { fieldName: this.props.fieldName, fieldValue: this.props.fieldValue, fieldSource: this.props.fieldSource, fieldSelected: this.props.fieldSelected });
                break;
            case 'checkbox':
                return '';
                break;
    ...
    render: function render() {
        return React.createElement(
            ...
            this.mountComponent(),
            React.createElement(EditableStoreButton, { fieldSource: this.props.fieldSource, callbackParent: this.onChildClick }),
...
var EditableSelectInput = React.createClass({
    ...
    render: function render() {
        ...
        return React.createElement(
            'select',
            { name: this.props.fieldName, id: 'editableInput', value: this.state.defValue, onChange: this.handleChange },
            selectNodes
        );
    }
});
